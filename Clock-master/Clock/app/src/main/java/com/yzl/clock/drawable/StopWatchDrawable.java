...
public class StopWatchDrawable extends Drawable {
    ...
    protected int[] linearColors = new int[]{color3, color2, color3};
    ...
    protected float[] linearPositions = new float[]{0f,0.5f,1f};

    public StopWatchDrawable(float w, float h) {
        this.h = h;
        this.w = w;
        ...
        centerRectF = new RectF(
                margin + shadowWidth + circleWidth / 2,
                margin + shadowWidth + circleWidth / 2 - mYOffset,
                w - (margin + shadowWidth + circleWidth / 2),
                h - (margin + shadowWidth + circleWidth / 2 - mYOffset));
        innerRectF = new RectF(
                margin + shadowWidth + circleWidth + shadowWidth / 2,
                margin + shadowWidth + circleWidth + shadowWidth / 2 - mYOffset ,
                w - (margin + shadowWidth + circleWidth + shadowWidth / 2),
                h - (margin + shadowWidth + circleWidth + shadowWidth / 2 - mYOffset)
        );
    }
